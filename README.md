...
Le site sera optimisé et prêt pour le déploiement dans le dossier `.next`.
...
- **Publish directory**: `out` (pour Next.js export statique) ou `.next/standalone` (pour Node.js)

**Note importante**: Pour Netlify, il est recommandé d'utiliser l'export statique. Modifiez `next.config.ts` si nécessaire :
...
### Problème : Erreur de déployement Netlify
...
#   P o r t f o l i o - M u t u o n - J o a n - 2 0 2 6  
 